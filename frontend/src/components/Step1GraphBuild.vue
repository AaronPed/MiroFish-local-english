      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <div v-if="currentPhase === 0 && ontologyProgress" class="progress-section">
            ...
            <span>{{ ontologyProgress.message || 'LoadingAnalyze Doc...' }}</span>
          </div>
        ...
        <div class="card-content">
          ...
          <div class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">Relation Edge</span>
            </div>
            <div class="stat-card">
...
const handleEnterEnvSetup = async () => {
  ...
  try {
    ...
    if (res.success && res.data?.simulation_id) {
      ...
      console.error('Sim Create Failed:', res.error)
      alert('Sim Create Failed: ' + (res.error || 'Unknown Error'))
    }
  } catch (err) {
    console.error('Sim Create Error:', err)
    alert('Sim Create Error: ' + err.message)
  } finally {
