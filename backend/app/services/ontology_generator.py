...
**Important: You must output valid JSON format data, without any other content.**
...
- Specific group representatives (e.g., alumni associations, fan groups, rights-protection groups)
...
A. **Fallback types (must be included, place at the end of the list)**:
   - `Person`: Fallback type for any natural person. Use when an individual does not belong to any other more specific person type.
...
- The text will mention various people, such as "primary/secondary school teachers", "passerby A", "some netizen"
- If there is no dedicated type to match them, they should be classified under `Person`
