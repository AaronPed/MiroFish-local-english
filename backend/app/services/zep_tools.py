...
class ZepToolsService:
    ...
    def get_node_edges(self, graph_id: str, node_uuid: str) -> List[EdgeInfo]:
        ...
        Returns:
            边列表
        """
        logger.info(f"Get related edges for node {node_uuid[:8]}...")
    ...
    def get_entities_by_type(
        ...
        Returns:
            符合类型的实体列表
        """
        logger.info(f"Get entities of type {entity_type}...")
    ...
    def get_entity_summary(
        ...
        Returns:
            实体摘要信息
        """
        logger.info(f"Get relationship summary for entity {entity_name}...")
    ...
    def get_graph_statistics(self, graph_id: str) -> Dict[str, Any]:
        ...
        Returns:
            统计信息
        """
        logger.info(f"Get statistics for graph {graph_id}...")
    ...
    def _generate_sub_queries(
        ...
        """
        system_prompt = """You are a professional problem analysis expert. Your task is to break down a complex question into multiple sub-questions that can be independently observed in the simulation world.
...
Return a JSON list of sub-questions."""
    ...
    def interview_agents(
        ...
        if not profiles:
            logger.warning(f"Profile file not found for simulation {simulation_id}")
    ...
    def _select_agents_for_interview(
        ...
        system_prompt = """You are a professional interview planning expert. Your task is to select the most suitable agents to interview from the simulation agent list based on the interview requirement.

Selection criteria:
1. The agent's identity/profession is relevant to the interview topic
2. The agent may hold unique or valuable perspectives
3. Choose diverse viewpoints (e.g., supporters, opponents, neutrals, professionals)
...
Please select up to {max_agents} most suitable agents for the interview and explain your reasoning."""
        ...
        try:
            ...
            logger.warning(f"LLM select agents failed, using default selection: {e}")
            # 降级：选择前N个
